...
export default function Home() {
  return (
    <>
      <Header />
      <img src="BG02.jpg" alt="BgImg" className="fixed top-0 left-0 w-full h-full object-cover z-0" />
      <div className="relative z-10">
        {/* Section 1 */}
        <section className="flex items-center justify-center h-screen px-2">
          {/* TopCharacter */}
        ...
        {/* Section 2 */}
        <section className="flex items-center justify-center h-screen text-center px-2 bg-gradient-to-b from-transparent to-gray-900">
          <p className="text-2xl text-white">This is some description for the second section. It has a gradient background.</p>
        </section>

        {/* Section 3 */}
        <section className="flex items-center justify-center h-screen text-center px-2 bg-black">
          <p className="text-2xl text-white">This is some description for the third section. It has a solid black background.</p>
        </section>

        {/* Section 4 */}
        <section className="flex items-center justify-center h-screen text-center px-2 bg-gradient-to-b from-gray-900 to-transparent">
